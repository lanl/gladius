...
{
    // #282829
    return QColor(40, 40, 41);
}

/**
 * @brief getForgroundColor
 * @return
 */
QColor
getForegroundColor(void)
{
    // B2BDC1
    return QColor(178, 189, 193);
}

view::view()
{
    //
    const unsigned screenID = 0;
    QRect screenGeometry = getScreenGeometry(screenID);
    //
    ...
    scene.setBackgroundBrush(QBrush(getBackgroundColor()));
    //
    QLineF line(10, 10, 100, 10);
    scene.addLine(line, QPen(getForegroundColor()));
    //
